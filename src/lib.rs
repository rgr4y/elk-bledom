 ...
 * Audio monitoring and visualization
 ...
 async fn main() -> Result<(), Error> {
     ...
     let mut device = BleLedDevice::new_without_power(None).await?;
...
pub use device::{BleLedDevice, Days, DeviceConfig, DeviceFilter, DeviceType, Effects, EFFECTS, WEEK_DAYS};
